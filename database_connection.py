...
CONNECT_STRING = '(description= (retry_count=20)(retry_delay=3)(address=(protocol=tcps)(port=1522)(host=adb.us-chicago-1.oraclecloud.com))(connect_data=(service_name=gf455d8269338dd_duck_medium.adb.oraclecloud.com))(security=(ssl_server_dn_match=yes)))'
def run_app():
	try:
